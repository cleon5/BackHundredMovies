...
@Repository
public class HundredSagaDAOImpl implements HundredGenericsDAO {
    ...
    public List getAll() {
        ...
        Query<?> theQuery = currentSession.createQuery("from Saga", Saga.class);
    ...
    public Object getByID(int id) {
        Session currentSession = entityManager.unwrap(Session.class);
        return currentSession.get(Saga.class, id);
    }
